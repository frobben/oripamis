...
<? $intro = get_post(1); ?>
    ...
    <div class="products-catagories-area clearfix">
        ...
        <div class="presentation" style="background-image: url('<?= get_the_post_thumbnail_url($intro); ?>')">
        ...
        <div class="intagram-wrapper">
            <a href="https://www.instagram.com/oripamis/"><h3>Nous suivre sur Instagram</h3></a>
            <?= do_shortcode(' [instagram-feed num=9 cols=3 showfollow=false]') ?>
        </div>
    </div>
